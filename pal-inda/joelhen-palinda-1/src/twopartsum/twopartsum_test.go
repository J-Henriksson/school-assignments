...
func TestSumConcurrentCorrectlySumsAnEmptyArray(t *testing.T) {
	arr := []int{}
	expected := 0
...
// test that ConcurrentSum sums an array with one element correctly
func TestSumConcurrentCorrectlySumsAnArrayWithOneElement(t *testing.T) {
	arr := []int{1}
	expected := 1
