...
public class ReverseTest {
    ...
    public void reversedListDoesNotMutateOriginalWhenNonEmpty() {
        ...
        // Act
        reverse.reversed(oddListCopy);
        reverse.reversed(evenListCopy);

        // Assert
        assertNotSame(oddListCopy, oddLengthList); // Ensure it's a different object reference
        assertNotSame(evenListCopy, evenLengthList);

        // Check the contents are the same using assertEquals
    ...
    public void reversedListIsEqualToOriginalWhenLengthIsOne() {
        ...
        // Assert
        assertNotSame(singleElementList, reversedSingleElementList); // Ensure it's a different object reference
