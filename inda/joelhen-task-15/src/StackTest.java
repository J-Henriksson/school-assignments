...
public abstract class StackTest {
    ...
    public void popFiveTimesDecreasesSizeByFive() {
        int decreasedSize = stack.size() - 5;
        // Act
        popElements(stack, 5);
        // Assert
        assertThat(stack.size(), equalTo(decreasedSize));
    }

    @Test
    public void pushFiveTimesIncreasesSizeByFive() {
        int increasedSize = stack.size() + 5;
        // Act
        for (int i = 0; i < 5; i++) {
            stack.push(1);
        }
        // Assert
        assertThat(stack.size(), equalTo(increasedSize));
    }
