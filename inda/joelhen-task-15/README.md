# Stacks
One key idea is that we use primitive datastructures to build more sophisticated datastructures. With stacks, we can choose to implement them using an array or a linked list. There are pros and cons for both implementations, but the main attractions of using a linked list are: all of the stack operations happen at the top of the stack, which can be modeled using the head element of a linked list (which is a constant timecost O(1)); and we do not have to be concerned about the size of the list as it will dynamically grow with no implications (as long as there is free memory).
...
### 📝 Preparation
- Read and answer all questions in Module 6: [Stacks](https://qbl.sys.kth.se/sections/dd1338_ht23_algoritmer_och_dat/container/stacks)
- You can access the OLI material both:
  ...
  - or directly at this [webpage](https://qbl.sys.kth.se/sections/dd1338_ht23_algoritmer_och_dat/container/stacks)- Self-study regular expressions:
- Follow this [Tutorial on Regular Expressions](http://www.vogella.com/tutorials/JavaRegularExpressions/article.html)


### ✅ Learning Goals
* Creating interfaces within inheritance relationships
* Implementing a stack in Java
* Estimating the time complexity of operations on a stack
...
#### Task 15.1 - Create a Stack Interface
...
#### Task 15.2 - Create an implementation of Stack
...
#### Task 15.3 - Evaluation of postfix expressions
