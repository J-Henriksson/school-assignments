...
public class HashSet<T> implements Set<T> {
    ...
    public HashSet(int capacity) {
        ...
        //Initializes each LinkedList in the array.
    ...
    /**
     * Helper method to retrieve the given index of an element.
     *
     * Complexity: O(1) expected time.
     *
     * @param elem An element to to check the index of.
     * @return The element's index or what index it should have.
     */
    ...
    public boolean contains(T elem) {
        return table[index(elem)].contains(elem);
    }
    ...
    public static void main(String args[]) {
        HashSet<Integer> Adam = new HashSet<>(50);
        Adam.add(5);
        Adam.add(10);
        System.out.println(Adam.contains(5));
        System.out.println(Adam.contains(10));
    }
}