...
public class Box implements Comparable<Box> {
    ...
    /**
     * Compares this box with another box based on their volumes.
     *
     * @param otherBox The other box to compare with.
     * @return A negative integer, zero, or a positive integer 
     * depending on how the volumes compare.
     */
    @Override
    public int compareTo(Box otherBox) {
        int differenceInVolume = this.volume() - otherBox.volume();

        return differenceInVolume;
    }
